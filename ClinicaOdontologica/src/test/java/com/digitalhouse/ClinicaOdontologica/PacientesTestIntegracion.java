...
public class PacientesTestIntegracion {
    ...
    public void cargarDatos(){
        Domicilio domicilio = new Domicilio("falsa",85,"Cali","Colombia");
        Paciente paciente = new Paciente("Waira","Restrepo", "res753", LocalDate.of(2024,12,11), domicilio,"waira@dh.com");
